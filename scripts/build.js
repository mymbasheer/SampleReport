...
function getDeploymentDomain() {
  // Preferred: full API URL (e.g. https://your-server.com)
  if (process.env.EXPO_PUBLIC_API_URL) {
    return stripProtocol(process.env.EXPO_PUBLIC_API_URL);
  }

  // Legacy: domain-only env var
  ...
  console.error(
    ...
    "Set EXPO_PUBLIC_API_URL=https://your-server.com before running the build.\n" +
    "Example: EXPO_PUBLIC_API_URL=https://your-server.com node scripts/build.js"
  );
  process.exit(1);
}
